...
#import "DZNEmptyDataStyle+Custom.h"
...
+ (instancetype)ctm_listStyle {
    DZNEmptyDataStyle *style = [self ctm_style];
        style.ctm_noNetworkImage = [UIImage imageNamed:@"noNetWorkImg.png"] ;
        style.ctm_noDataImage = style.ctm_failureImage = [UIImage imageNamed:@"noDataFace.png"];
