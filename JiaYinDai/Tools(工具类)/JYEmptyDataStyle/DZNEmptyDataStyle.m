...
- (BOOL)emptyDataSetShouldDisplay:(UIScrollView *)scrollView {
    ...
    if ([scrollView isKindOfClass:[UITableView class]]) {
        ...
        if (section) {
            NSInteger rows = [tableView.dataSource respondsToSelector:@selector(tableView:numberOfRowsInSection:)] ? [tableView.dataSource tableView:tableView numberOfRowsInSection:0] : 0;
